...
// Ispire https://dev.to/ycmjason/building-a-simple-virtual-dom-from-scratch-3d05
// TODO: Need to refactoring and eslint fixing
...
const diffAttrs = (oldAttrs = {}, newAttrs = {}) => {
  ...
  for (const [k, v] of Object.entries(newAttrs)) {
    patches.push(($node) => {
      // TODO:  we can check the values before setting
